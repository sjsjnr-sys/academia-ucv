  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-base p-4">
      <Card className="w-full max-w-[400px] p-8 shadow-lg border-border-subtle bg-bg-elevated flex flex-col items-center">
        ...
        <p className="text-text-secondary text-sm mb-8">Crea tu cuenta de estudiante</p>
        ...
        <form action={formAction} className="w-full space-y-4">
          <div className="space-y-1">
            <label htmlFor="full_name" className="text-xs font-semibold text-text-secondary">
              Nombre completo
            </label>
            <Input
              id="full_name"
